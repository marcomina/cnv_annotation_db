...
zcat ${DATA_FOLDER}/GRCh38.2019_11_03.variant_call.vcf.gz | grep -v 'SVTYPE=BND' > processing/temp_GRCh38.2019_11_03.variant_call.vcf # Warnings! Could generates a big file. Can directly load the gzipped file in R if necessary
